...
CREATE USER 'rpdd'@'localhost' IDENTIFIED BY 'rpd.2019';
GRANT ALL PRIVILEGES ON rpd.* TO 'rpd'@'localhost';
FLUSH PRIVILEGES;
GRANT ALL PRIVILEGES ON epd_proyecto.* TO 'epd2019'@'localhost';
FLUSH PRIVILEGES;
